...
if 'group' not in st.session_state:
    ...
    st.session_state.widget_input = "" # 입력창 제어용
...
if st.session_state.step == 'intro':
    ...
    with st.container(border=True):
        st.write("안녕하세요. 본 연구는 생성형 AI의 정보 표현 방식에 따른 사용자 인식을 알아보기 위한 연구입니다.")
...
# --- [2페이지] AI 대화 화면 ---
    ...
    # [고도화 1] 그룹별 배경색 CSS 주입
    bg_color = "#EAFFEA" if st.session_state.group == "Positive" else "#FFF0E0"
    st.markdown(f"""
        <style>
        .stApp {{
